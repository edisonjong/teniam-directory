    ...
    <section className="py-32">
      <div className="mx-auto max-w-3xl px-8 lg:px-0">
        ...
        <p className="mt-4 text-center">
          Teniam delivers advanced application solutions, driving meaningful
        ...
        <Card className="mx-auto mt-12 max-w-lg p-8 shadow-md sm:p-16">
          ...
          >
            ...
            <div>
              <Label htmlFor="job">Tech Roles Enabled</Label>
              <Select>
                <SelectTrigger>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="2">IT Operations</SelectItem>
                  <SelectItem value="3">Product Management</SelectItem>
                  <SelectItem value="4">Data Science & Analytics</SelectItem>
                  <SelectItem value="5">Cybersecurity</SelectItem>
                  <SelectItem value="6">Cloud Architecture</SelectItem>
